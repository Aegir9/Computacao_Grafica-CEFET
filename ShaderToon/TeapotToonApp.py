...
class TeapotTextureApp(GLAPP):
    ...
    def setup(self):
        ...
        # Pipeline (shaders)
        self.pipeline = self.loadPipeline("ToonShader")
    ...
    def drawTeapot(self):
        ...
        if self.arrayBufferId == None:
            ...
            GL.glBufferData(GL.GL_ARRAY_BUFFER, len(normals)*normals.itemsize, ctypes.c_void_p(normals.buffer_info()[0]), GL.GL_STATIC_DRAW)
